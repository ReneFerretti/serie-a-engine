...
# 4. SCARICAMENTO CLASSIFICA E STATISTICHE
...
if res_standings.status_code == 200:
    ...
    home_dict = {row['team']['name']: row for row in home_table}
    away_dict = {row['team']['name']: row for row in away_table}
...
if response_all.status_code == 200:
    ...
    for match in partite:
        ...
        if stato == 'FINISHED':
            ...
            # Calcolo probabilità Doppie Chances
            p_1x = p1 + px
            p_x2 = px + p2
            p_12 = p1 + p2
    ...
    print(f"\nFatto! File aggiornati con doppie chances (1X, X2, 12) salvati sulla Scrivania.")
